...
bedfile = "mena_evolutionary_longer.bed12"  #edit path as needed
bed = open(bedfile, 'r')

old_cleavage = "mena_evolutionary_longer_old.txt"
old_sites = open(old_cleavage, 'r')

cleavage_site_seqs = "mena_cleavage_seqs_shortened.txt"
stripped = open(cleavage_site_seqs, 'w')

cleavage_site_names = "mena_cleavage_names_shortened.txt"
names = open(cleavage_site_names, 'w')

new_cleavage = "mena_evolutionary_longer.txt"

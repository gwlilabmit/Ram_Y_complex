...
bedfile = "metn_correct_evolutionary_longer.bed12"  #edit path as needed
bed = open(bedfile, 'r')

old_cleavage = "metn_evolutionary_longer_old.txt"
old_sites = open(old_cleavage, 'r')

cleavage_site_seqs = "metn_cleavage_seqs_shortened.txt"
stripped = open(cleavage_site_seqs, 'w')

cleavage_site_names = "metn_cleavage_names_shortened.txt"
names = open(cleavage_site_names, 'w')

new_cleavage = "metn_evolutionary_longer.txt"

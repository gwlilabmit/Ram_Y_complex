...
#the cleavage site is the 100th nt, i.e. index 99, in all sites
cleavage_site = 99 


infiles = glob.glob("*_consensus_for_varna.txt") #this is the naming convention I've used for my consensus files 
...
for structure in infiles: 
	...
	for line in infile: 
		if ">" in line: #i.e., if it specifies the name of the file as per fasta conventions
			...
			site = cleavage_site #all cleavage sites have the same location

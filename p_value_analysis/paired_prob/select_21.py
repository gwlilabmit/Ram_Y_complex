...
structures = glob.glob("*5prime_paired_folded.txt") #get all dms-constrained folded sites 

num_windows = 21 #number of windows you want to get, same as what you have for cleavage sites
cleavage_paired = 12 #number of cleavage sites you actually witness being paired 

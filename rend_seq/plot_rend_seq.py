...
for i in range(len(starting)):
	...
	cleavage = cleavage_sites[window_name]-1 #-1 #subtract 1 to account for zero indexing--the 100th base in the window is the 99th index 
	...
	#color[cleavage]="b" #color the cleavage site bar blue
	#edgecolor[cleavage]="b" #color the cleavage site bar's edge blue
...
for i in range(len(starting)):
	...
	plt.figure(j)
	#plt.scatter(cleavage, 0, s=1, color="#cc6633", label="Cleavage site 5'") #add a dot to the cleavage site bar so we can label it

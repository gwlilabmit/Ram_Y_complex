...
structures_file = open(name+"_structures.txt", "r") #file with all the structures you care about
#We'll also write our final paren-matched consensus sequence to a new fasta-format file that has: 
#>sequence name
#sequence
#consensus_matched

sequence_file = open("rna_"+name+".txt", "r")
outfile = open(name+"_consensus_for_varna.txt", "w")

#Initialize a list of dot brackets based on the structures present in the input file 

dot_brackets = [] 

for line in structures_file:
...
print "consensus structure: "+ consensus_struct
print "consensus pairing: "+ consensus_paired
print "consensus structure with matched parens: "+ consensus_matched
print "paired nts with matched parens: "+ paired_matched
